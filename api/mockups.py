...
def mockup_generator(image_path):
    mockup_urls = []  # List to store URLs of generated mockups
    ...
    if not uploaded_image_url:
        ...
        return ["Image upload to imgbb failed. Aborting mockup generation."]
    ...
    variant_ids = {
        "square": {"canvas": 824, "poster": 6879},
        "vertical": {"canvas": 3, "poster": 6880},
        "horizontal": {"canvas": 3, "poster": 6880}
    }
    ...
    canvas_mockup_urls = handle_mockup_response(response, f"{filename}_canvas", url_task_status, headers)
    mockup_urls.extend(canvas_mockup_urls)
    ...
    poster_mockup_urls = handle_mockup_response(response, f"{filename}_poster", url_task_status, headers)
    mockup_urls.extend(poster_mockup_urls)
